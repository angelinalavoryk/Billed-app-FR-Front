...
describe("Given I am connected as an employee", () => {
  describe("When I am on Bills Page", () => {
    // Vérifie si l'icône des factures est surligné quand l'utilisateur est connecté
...
describe("When an error occurs on API", () => {
  ...
  test("Then fetches bills from an API and fails with 404 message error", async () => {
    ...
    // Afficher la page BillsUI avec l'erreur spécifiée
    const html = BillsUI({ error: "Erreur 404" });
    document.body.innerHTML = html;

    // Vérifier que le message d'erreur 404 est correctement affiché à l'écran
  ...
  test("Then fetches bills from an API and fails with 500 message error", async () => {
    ...
    // Vérifier que le message d'erreur 500 est correctement affiché à l'écran
